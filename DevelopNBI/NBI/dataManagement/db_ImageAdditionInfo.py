...
class imageAddtionalInfo():
    def __init__(self, gid, sampleName, part=None, preDiagnosis=None, remark=None,pathologic=None,differentiation=None,infiltration=None,cuttingEdge=None):
        self.gid = gid
