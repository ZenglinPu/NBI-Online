...
class NBIManager():
    def __init__(self, table):
        self.__conn = pymongo.MongoClient('mongodb://{}:{}@{}:{}/?authSource={}'.format("root", "buptweb007", "49.232.229.126", "27017", "admin"))
        if table == "PhotoInfo":
    ...
    def clearAllImageData(self):
        if input("Make sure you want to clear all image data[y/N]:") == 'y':
            os.system("rm -rf /home/ubuntu/DevelopNBI/static/Data")
            os.system("mkdir /home/ubuntu/DevelopNBI/static/Data")
            os.system("mkdir /home/ubuntu/DevelopNBI/static/Data/Blue")
            os.system("mkdir /home/ubuntu/DevelopNBI/static/Data/Green")
            os.system("mkdir /home/ubuntu/DevelopNBI/static/Data/NBI")
            os.system("mkdir /home/ubuntu/DevelopNBI/static/Data/Temp")
