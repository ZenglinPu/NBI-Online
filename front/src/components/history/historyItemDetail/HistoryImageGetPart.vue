<template>
  <div id="imgShowPart">
    <div class="subTitle">
      <p
        style="height: 50%;font-family: STHeiti,serif;color: #363636;display: flex;justify-content: center;align-items: center;margin: 0 0 0 2%;">
        生成结果(Get Result):</p>
      <div style="width: 100%;height: 50%;display: flex;flex-direction: row;">
        <div style="width: 60%;height: 100%;display: flex;flex-direction: row;">
          ...
          <el-popover placement="top-start" width="100" trigger="hover" content="是否在历史记录中保存此次提交，未保存的数据仅会在历史记录中保存24小时！">
        ...
        <div style="height: 100%;width: 40%;display: flex;justify-content: end;">
          <el-button id="downloadResult" type="warning" icon="el-icon-download" @click="downloadResult()">下载结果
          </el-button>
        </div>
      </div>
    </div>
