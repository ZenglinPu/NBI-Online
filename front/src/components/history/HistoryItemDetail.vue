<template>
    <el-row :gutter="20">
        <el-col :span="8" :offset="1">
            <el-image :src="ruleForm.url" :preview-src-list="ruleForm.srcList">
            </el-image>
        </el-col>
        <el-col :span="9" :offset="1">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="术前诊断" prop="preDiagnosis">
                    <el-checkbox-group v-model="ruleForm.preDiagnosis">
                        <el-checkbox label="早癌" name="preDiagnosis" disabled></el-checkbox>
                        <el-checkbox label="LGIN" name="preDiagnosis" disabled></el-checkbox>
                        <el-checkbox label="腺癌" name="preDiagnosis" disabled></el-checkbox>
                        <el-checkbox label="炎症" name="preDiagnosis" disabled></el-checkbox>
                        <el-checkbox label="其他" name="preDiagnosis" disabled></el-checkbox>
                    </el-checkbox-group>
                </el-form-item>
                <el-form-item label="病理诊断" prop="pathologic">
                    <el-checkbox-group v-model="ruleForm.pathologic">
                        <el-checkbox label="早癌" name="pathologic"></el-checkbox>
                        <el-checkbox label="LGIN" name="pathologic"></el-checkbox>
                        <el-checkbox label="腺癌" name="pathologic"></el-checkbox>
                        <el-checkbox label="炎症" name="pathologic"></el-checkbox>
                        <el-checkbox label="其他" name="pathologic"></el-checkbox>
                    </el-checkbox-group>
                </el-form-item>
